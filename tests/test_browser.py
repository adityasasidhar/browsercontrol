...
class TestTabManagement:
    ...
    async def test_create_tab_with_url(self, mock_context, mock_page):
        ...
        new_page.goto.assert_called_once_with("https://example.com", wait_until="domcontentloaded", timeout=30000)
