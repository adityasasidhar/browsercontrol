...
class TestClick:
    ...
    @pytest.mark.asyncio
    async def test_click_valid_element(self, mcp_server, mock_browser_manager, mock_page, sample_element_map):
        ...
        with patch('browsercontrol.tools.interaction.browser', mock_browser_manager):
            with patch('browsercontrol.tools.interaction.get_element_map', return_value=sample_element_map):
                mock_browser_manager.page = mock_page
                mock_browser_manager.screenshot_with_som.return_value = (b"screenshot", sample_element_map)
    ...
    @pytest.mark.asyncio
    async def test_click_invalid_element(self, mcp_server, mock_browser_manager, mock_page, sample_element_map):
...
class TestTypeText:
    ...
    @pytest.mark.asyncio
    async def test_type_text_into_input(self, mcp_server, mock_browser_manager, mock_page, sample_element_map):
...
class TestHover:
    ...
    @pytest.mark.asyncio
    async def test_hover_over_element(self, mcp_server, mock_browser_manager, mock_page, sample_element_map):
...
class TestScrollToElement:
    ...
    @pytest.mark.asyncio
    async def test_scroll_to_element(self, mcp_server, mock_browser_manager, mock_page, sample_element_map):
