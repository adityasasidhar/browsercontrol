...
class TestRecording:
    ...
    @pytest.mark.asyncio
    async def test_stop_recording(self, mcp_server, mock_browser_manager, mock_context, temp_recordings_dir):
...
class TestSnapshot:
    ...
    @pytest.mark.asyncio
    async def test_take_snapshot(self, mcp_server, mock_browser_manager, mock_page, temp_recordings_dir):
